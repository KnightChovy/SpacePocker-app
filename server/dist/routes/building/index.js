...
buildingRouter.use(authUtils_1.authentication);
buildingRouter.post('/buildings', (0, asyncHandler_1.asyncHandler)(building_container_1.buildingController.createBuilding));
buildingRouter.patch('/buildings/:id', (0, asyncHandler_1.asyncHandler)(building_container_1.buildingController.updateBuilding));
buildingRouter.delete('/buildings/:id', (0, asyncHandler_1.asyncHandler)(building_container_1.buildingController.deleteBuilding));
