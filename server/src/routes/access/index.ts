...
router.post("/auth/forgot-password", asyncHandler(accessController.forgotPassword));
router.post(
  "/auth/verify-forgot-password-otp",
  asyncHandler(accessController.verifyForgotPasswordOtp),
);
router.post("/auth/reset-password", asyncHandler(accessController.resetPassword));
