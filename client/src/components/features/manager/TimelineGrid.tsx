      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 border-b border-border-light gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="text-xs font-semibold text-primary hover:text-primary-dark ml-2">
              Today
            </button>
          </div>
        </div>
        ...
        <div className="flex min-h-full">
          ...
          >
            ...
            >
              ...
              >
                <div className="absolute -top-1.5 -left-1.5 h-3 w-3 bg-red-500 rounded-full"></div>
              </div>
                  ...
                  {BOOKINGS.filter(b => b.roomId === room.id).map(booking => (
                    <div
                      ...
                      style={{
                        ...
                        width: getTimeWidth(booking.startTime, booking.endTime),
                      }}
                    >
                      {booking.icon && (
                        <div
