  ...
  return (
    <section className="px-4 pb-24 sm:px-6 lg:px-8">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] shadow-2xl">
        ...
        <div className="relative z-10 px-6 py-16 sm:px-16 md:py-24">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Button className="rounded-xl bg-white px-8 py-4 text-base font-bold text-primary shadow-lg transition-transform hover:scale-105 hover:text-white active:scale-95">
                List your Space
              </Button>
