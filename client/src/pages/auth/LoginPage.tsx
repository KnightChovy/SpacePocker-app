  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row antialiased bg-background-light dark:bg-background-dark text-[#0e0d1b] dark:text-white">
      ...
      <div 
        ...
        style={{ backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuBTUKlrbWweEhTIsMCDyHh9Quo2Ja6uVORCyxaldKUOLGvESW_KOi3X5ueAuN1WqHE8K_Qt3b1nHMY-S3ukomJw3SpgDiDO83nkdUu1B5raK_m4UEDmPrE0ZL3OSKuPuXA-yMwGL5Bx4hM_WXCa0CY6LIVyEznBqz8VsEuYOEkMLoJrUxnpwGklW-4E2VRKe1SaBO1L3TFOLXTKJsqtOul-hSc_OmXGXnJ1VH3WiXndSKlta6gCxW9Yjyq1LgUi3H5nSxRhnN3zFcy7')` }}
      >
        ...
        <div className="relative z-10 animate-fade-in-up">
          <div className="flex items-center gap-2 text-white">
            <div className="flex items-center justify-center w-10 h-10 rounded-lg glass-card">
            </div>
            <span className="text-2xl font-black tracking-tight">SPACEPOCKER</span>
          </div>
        </div>
        ...
        <div className="relative z-10 glass-card rounded-xl p-6 max-w-lg mt-auto animate-fade-in-up hover:scale-[1.01] transition-transform duration-500 ease-out">
          <div className="flex flex-col gap-4">
            <div className="flex gap-1 text-[#FFD700]">
              {[1, 2, 3, 4, 5].map((s) => (
                <span key={s} className="material-symbols-outlined text-[20px] fill-1">star</span>
              ))}
            </div>
            <p className="text-white text-xl font-medium leading-relaxed tracking-tight">
              "Spacepocker completely transformed how we manage our university's study pods. The booking flow is seamless and the interface is stunning."
            </p>
            <div className="flex items-center gap-4 mt-2 pt-4 border-t border-white/10">
              <div 
                ...
                style={{ backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuC0epEoHMaSCepXaFlkmUci9EDtDD6rkcHs27ywPLuiG_khCWZdafrMxlY_ztx2LZ53n5tx8oIb0hwhFlh-YCdbIjszn2MoUqIHbEAn6eWI4Nre90j9v7YGbNsg87eSB3zllYLETa93EKtB4GsdDUIg8hFIQletuN6mu1SPjM3WpXHEbrQgvMI05XXWiEfWTafzgSejXoJzj2Y-oF7ebiQQUR4Gj_hXvhS-P65_1JAVa7dVll6I8SFmWwKxty0KAz8RiuyNlP_7odPC')` }}
              ></div>
              <div>
                <p className="text-white font-bold text-base">Elena Rodriguez</p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center relative bg-white dark:bg-[#151725] p-6 sm:p-12 xl:p-24 overflow-y-auto">
        ...
        <div className="w-full max-w-110 flex flex-col gap-8 relative z-10">
          <div className="lg:hidden flex items-center gap-2 text-primary mb-2">
            <span className="text-xl font-black tracking-tight text-[#0e0d1b] dark:text-white">SPACEPOCKER</span>
          </div>
          
          <div className="flex flex-col gap-2">
            <h1 className="text-[#0e0d1b] dark:text-white text-3xl md:text-4xl font-black leading-[1.1] tracking-[-0.02em]">Welcome back</h1>
            <p className="text-[#4d4c9a] dark:text-gray-400 text-base font-normal">Please enter your details to sign in.</p>
          </div>
          ...
          <button className="group flex w-full cursor-pointer items-center justify-center rounded-xl h-14 px-5 bg-white dark:bg-[#1c1e31] border border-[#e5e7eb] dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[#252840] hover:border-[#d1d5db] dark:hover:border-gray-600 transition-all duration-200 shadow-sm gap-3 relative overflow-hidden">
            ...
            />
            <span className="text-[#0e0d1b] dark:text-white font-semibold text-base">Sign in with Google</span>
          </button>

          <div className="relative flex py-1 items-center">
            <div className="grow border-t border-gray-200 dark:border-gray-700"></div>
            <span className="shrink-0 mx-4 text-gray-400 text-sm font-medium">Or sign in with email</span>
            <div className="grow border-t border-gray-200 dark:border-gray-700"></div>
          </div>
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div className="space-y-5">
              <div className="group relative">
                <label className="block text-[#0e0d1b] dark:text-gray-200 text-sm font-semibold mb-2 ml-1" htmlFor="email">Email</label>
              ...
              <div className="group relative">
                <label className="block text-[#0e0d1b] dark:text-gray-200 text-sm font-semibold mb-2 ml-1" htmlFor="password">Password</label>
                <div className="relative">
                  <input 
                    className="peer w-full h-12 pl-4 pr-12 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-[#1c1e31] text-[#0e0d1b] dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/80 focus:bg-white dark:focus:bg-[#1c1e31] transition-all duration-200 ease-out shadow-sm"
                    id="password"
            ...
            <p className="text-center text-[#4d4c9a] dark:text-gray-400 text-sm mt-2">
              Don't have an account? <a className="text-primary font-bold hover:text-[#8B5CF6] transition-colors" href="#">Sign up</a>
            </p>
          </form>
        </div>
