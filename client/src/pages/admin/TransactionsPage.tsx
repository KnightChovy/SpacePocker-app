...
const TransactionsPage: React.FC = () => {
  ...
  return (
    <>
      <AppHeader
        title="Transactions"
        subtitle="Monitor platform transactions and payment statuses."
      ...
      <main className="flex-1 overflow-y-auto p-6 lg:p-10">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="bg-surface-light rounded-2xl shadow-float border border-gray-100 overflow-hidden">
            <div className="p-4 border-b border-gray-100 bg-gray-50/50 text-sm text-text-secondary-light">
              {isLoading
