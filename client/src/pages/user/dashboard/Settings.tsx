    ...
    <div className="p-4 md:p-8 scroll-smooth pb-24 relative">
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        <div>
          ...
          <p className="text-text-sub-light dark:text-text-sub-dark text-base">Manage your personal information, security preferences and notifications.</p>
        </div>
        ...
        <section className="bg-surface-light dark:bg-surface-dark rounded-2xl border border-border-light dark:border-border-dark shadow-sm">
          <div className="p-6 border-b border-border-light dark:border-border-dark">
            ...
            <p className="text-sm text-text-sub-light dark:text-text-sub-dark mt-1">Choose what we can contact you about.</p>
          </div>
